...
{
    public partial class FrmSqlExceptionLog : Form
    {
        private List<SqlExceptionLogEntity> _sqlRecordList;

        public FrmSqlExceptionLog()
        {
            InitializeComponent();
        }
        ...
        {
            Clear();
            _sqlRecordList = Common.LoadLog<SqlExceptionLogEntity>(Common.SqlExceptionLogPathKey);
        ...
        private void Clear()
        {
            _sqlRecordList = new List<SqlExceptionLogEntity>();
            dgv.Rows.Clear();
            coxDate.Items.Clear();
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                foreach (var sqlRecordEntity in selectSqlRecordList)
                {
                    ...
                    {
                        dgv.Rows.Add(entity.CreateAt, entity.CmdType, entity.MethodName, entity.LineNo, entity.Name, entity.Message, entity.Sql, sb.ToString());
                    });
                }
                Invoke((EventHandler)delegate
                {
        ...
        private void dgv_SelectionChanged(object sender, EventArgs e)
        {
            ...
            textBox9.Text = currentSqlRecord.Name;
        ...
        {
            if (Common.ClearLog<SqlExceptionLogEntity>(Common.SqlExceptionLogPathKey)) { btnRefresh.PerformClick(); }
        }
        ...
        {
            if (Common.OpenLoad(Common.SqlExceptionLogPathKey)) { btnRefresh.PerformClick(); }
        }
